                ...
                <div class="auth-wrapper auth-v2">
                    <div class="auth-inner row m-0">
                        ...
                        <a href="javascript:void(0);" class="brand-logo">
                            <img width="200px;" src="{{ url('frontend/assets/images/logo/logo-color.png') }}">
                        ...
                        <div class="d-none d-lg-flex col-lg-8 align-items-center login-banner">
                            <div class="w-100 d-lg-flex align-items-center justify-content-center login-banner"><img style="object-fit: cover; width: 100vw; height:100vh" src="{{ url('frontend/assets/images/others/backedn-login.webp') }}" alt="QC Legal Website Dashboard Login"></div>
                        </div>
                        <!-- /Left Text-->
                        <!-- Login-->
