                                ...
                                <tbody>
                                    @foreach($candidates as $candidate)
                                        <tr id="row-{{ $candidate->id }}">
                                            <td>{{ $candidate->id }}</td>
                                            <td>{{ $candidate->career_detail->title }}</td>
                                            ...
                                            <td>
                                                <div class="d-flex gap-5">
                                                    ...
                                                    <button data-id="{{ $candidate->id }}" data-job-id="{{ $candidate->job_id }}" data-firstname="{{ $candidate->first_name }}" data-lastname="{{ $candidate->last_name }}" data-email="{{ $candidate->email }}" data-phonenumber="{{ $candidate->phone_number }}" data-coverletter="{{ $candidate->cover_letter }}" data-cv="{{ url('uploads/cv') }}/{{ $candidate->cv }}" data-status="{{ $candidate->status }}" type="button" data-toggle="tooltip" data-placement="top" data-original-title="View" class="btn btn-dark waves-effect mb-1 view-candidate">
