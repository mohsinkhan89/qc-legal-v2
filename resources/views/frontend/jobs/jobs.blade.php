...
@section('title')
    <title>Legal Jobs UK - Apply Now for Top Law Roles | QC Legal</title>
...
@section('metas')
    <meta property="og:title" content="Legal Jobs UK - Apply Now for Top Law Roles | QC Legal">
    <meta name="description"
        content="Explore the best legal jobs across the UK with QC Legal. Top law firms hiring now. Apply today to land your next legal role with expert help from QC Legal.">
    <meta property="og:description"
        content="Explore the best legal jobs across the UK with QC Legal. Top law firms hiring now. Apply today to land your next legal role with expert help from QC Legal.">
    <meta name="twitter:title" content="Legal Jobs UK - Apply Now for Top Law Roles | QC Legal">
    <meta name="twitter:description"
        content="Explore the best legal jobs across the UK with QC Legal. Top law firms hiring now. Apply today to land your next legal role with expert help from QC Legal.">
@endsection

@section('content')
    <section class="lqd-section banner flex items-center bg-cover bg-center border-10 border-white qc-sublanding"
        id="landing"
        style="background: linear-gradient(93deg, #01091278, #0b223e73), url('{{ url('frontend/assets/images/bg/top-banner-desktop-latest-jobs-v2.webp') }}') no-repeat center/cover;">
        <div class="container">
            <div class="row items-center">
                <div class="col col-12 col-xl-10 offset-xl-1 relative flex flex-col justify-center items-center text-center"
                    ...
                    <h1 class="ld-fh-element lqd-highlight-custom-underline lqd-highlight-grow-left text-decoration-default lqd-split-chars relative mb-0 text-84 text-white"
                        data-inview="true" data-transition-delay="true"
                        data-delay-options='{"elements":".lqd-highlight-inner","delayType":"transition"}'
                        data-split-text="true" data-split-options='{"type":"chars, words"}' data-custom-animations="true"
                        data-ca-options='{"triggerHandler":"inview","animationTarget":".lqd-chars > .split-inner","duration":1800,"delay":"50","ease":"power4.out","direction":"forward","initValues":{"transformOriginX":100,"transformOriginY":100,"transformOriginZ":"100px","opacity":0},"animations":{"transformOriginZ":"-100px","opacity":1}}'>
                        Legal <mark class="lqd-highlight">
                            ...
                            <span class="lqd-highlight-inner h-auto left-0 bottom-0 qc-text-secondary">
                                <svg class="w-full relative block" xmlns="http://www.w3.org/2000/svg" width="235.509"
                                    height="13.504" viewbox="0 0 235.509 13.504" aria-hidden="true"
    ...
    <section
        class="lqd-section case-studies jshndle-section-fixed qc-x-section res-reset-height mainjobsearch flex items-center justify-center py-50 px-10vw bg-white lg:px-0 md:items-start"
        id="findjobsection" data-section-luminosity="light">
        <div class="container">
            <div class="row">
                        ...
                        <div class="qc-search-container">
                            <div class="qc-search">
                                <div class="qc-search-input">
                                    <input type="text" class="qc-search-input jshndle-job-search-input"
                                ...
                                <div class="qc-filter">
                                    <select class="qc-form-select jshndle-job-filter" data-filter="{{ $filter->slug }}">
                                        ...
                                        @foreach ($options as $option)
                                            <option value="{{ $option->slug }}">{{ $option->value }}
                                                ({{ $option->jobs_count }})</option>
                                        @endforeach
                                    </select>
                                </div>
                            @endforeach
                ...
                <div
                    class="col-lg-12 col-md-12 col-12 qc-error-handling-section notfound jshndle-notfound hide-status hide-true">
                    <div class="notfound-img">
                        <img src="{{ url('frontend/assets/images/others/jobnotfound.svg') }}" alt="Oops! Job Not Found"
                            class="img-fluid">
                    </div>
                    <div class="notfound-content">
                        <div class="ld-fancy-heading relative animation-element">
                            <h2 class="ld-fh-element relative mb-0/5em text-50 leading-1/1em" data-inview="true"
                                ...
                                <mark class="lqd-highlight">
                                    ...
                                    <span class="lqd-highlight-inner h-0/25em bottom-5 left-0 qc-bg-secondary-light">
                                        <svg class="hidden" xmlns="http://www.w3.org/2000/svg" width="235.509"
                                            height="13.504" viewbox="0 0 235.509 13.504" aria-hidden="true"
            ...
            <div class="qc-jobs-grand-parent-container jshndle-jobs-grand-parent-container hide-status hide-true">
                <div class="row">
                    <div
                        class="col-lg-5 col-md-5 col-12 px-10 mb-10 qc-container-height list-container jshndle-list-container">
                        <div class="qc-jobs-parent-container">
                    ...
                    <div
                        class="col-lg-7 col-md-7 col-12 px-10 mb-10 qc-container-height desc-container jshndle-desc-container">
    ...
    <script>
        $(document).ready(function() {
            ...
            function qcCapitalizeText() {
                const smallWords = ['and', 'or', 'of', 'in', 'on', 'at', 'to', 'for', 'by', 'with', 'a', 'an',
                    'the'];
            ...
            function qcEachJobUrlAndTitle() {
                ...
                const searchTerm = segments[0] && segments[0].toLowerCase() !== 'all' ? ucwords(decodeSeg(segments[
                    0])) : '';
            ...
            function renderJobs(jobs, replace = false) {
                ...
                jobs.forEach(job => {
                    let fields = [
                        ...
                        { value: job.qc_code_identity, icon: 'fa-solid fa-barcode' },
                    ];
                ...
                $.ajax({
                    ...
                    success: function(res) {
                        ...
                        if (res.jobs.length === 0) {
                            ...
                            $('.jshndle-jobs-grand-parent-container.hide-status').addClass(
                                'hide-true');
                            $('.jshndle-job-loadmore-button').addClass('qc-disabled');
                        } else {
                            $('.jshndle-jobs-grand-parent-container.hide-status').removeClass(
                                'hide-true');
                            $('.jshndle-notfound.hide-status').addClass('hide-true');
            ...
            $(document).on('click', '.jshndle-job-form-submit', function(event) {
                ...
                $('.text-invalid, .file-invalid, .check-invalid').removeClass(
                    'text-invalid file-invalid check-invalid');

                if (!firstName.val()) {
                    firstName.addClass('text-invalid');
                    isValid = false;
                }
                if (!lastName.val()) {
                    lastName.addClass('text-invalid');
                    isValid = false;
                }
                if (!email.val() || !/^\S+@\S+\.\S+$/.test(email.val())) {
                    email.addClass('text-invalid');
                    isValid = false;
                }
                if (!phone.val()) {
                    phone.addClass('text-invalid');
                    isValid = false;
                }
                if (!cover.val()) {
                    cover.addClass('text-invalid');
                    isValid = false;
                }
                if (!cv || !/\.(pdf|docx|jpg|png)$/i.test(cv.name)) {
                    $('#cvfile').closest('label').addClass('file-invalid');
                    isValid = false;
                }
                if (!terms.is(':checked')) {
                    terms.closest('label').addClass('check-invalid');
                    isValid = false;
                }
