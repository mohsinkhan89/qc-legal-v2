...
<body data-bgcolor="Body" style="margin-top: 0; margin-bottom: 0; padding-top: 0; padding-bottom: 0; width: 100%; -webkit-text-size-adjust: 100%; -ms-text-size-adjust: 100%;" bgcolor="#F4F4F4"> <span class="preheader-text" data-preheader-text style="color: transparent; height: 0; max-height: 0; max-width: 0; opacity: 0; overflow: hidden; visibility: hidden; width: 0; display: none; mso-hide: all;"></span>
	...
	<table border="0" align="center" cellpadding="0" cellspacing="0" width="100%" style="width:100%;max-width:100%;">
		<tr>
			...
			<td align="center" data-bgcolor="Body" bgcolor="#F4F4F4" data-composer>
				<table data-outer-table border="0" align="center" cellpadding="0" cellspacing="0" class="outer-table row" role="presentation" width="640" style="width:640px;max-width:640px;" data-module="colibri-preheader-18">
					...
					<tr>
						<td align="center" bgcolor="#fafafa" data-bgcolor="BgColor">
							...
							<table data-inner-table border="0" align="center" cellpadding="0" cellspacing="0" role="presentation" class="inner-table row" width="580" style="width:580px;max-width:580px;">
								<tr>
									<td align="center">
										...
										<table border="0" cellpadding="0" cellspacing="0" align="center" class="container-padding" width="100%" style="width:100%;max-width:100%;">
											<tr>
												<td class="rwd-col" align="center" width="46.66%" style="width:46.66%;max-width:46.66%;"> </td>
								...
								<tr data-element="colibri-preheader-18-logo" data-label="Logo">
									{{-- <td align="center" class="center-text"> <img style="width:270px;border:0px;display: inline!important;" src="{{ url('frontend/assets/images/logo/logo-color.png') }}" width="200" border="0" editable="true" data-icon data-image-edit data-url data-label="Logo" data-image-width alt="logo"> </td> --}}
									<td align="center" class="center-text"> <img style="width:270px;border:0px;display: inline!important;" src="{{ url('frontend/assets/images/logo/logo-color.png') }}" width="200" border="0" editable="true" data-icon data-image-edit data-url data-label="Logo" data-image-width alt="logo"> </td>
								</tr>
								<tr>
							...
							<table data-inner-table border="0" align="center" cellpadding="0" cellspacing="0" role="presentation" class="inner-table row container-padding" width="580" style="width:580px;max-width:580px;">
                                ...
                                @if($type == 'applicant')
                                    <tr data-element="colibri-bm-headline" data-label="Headlines">
                                        <td class="center-text" data-text-style="Headlines" align="center" style="font-family:'Poppins',Arial,Helvetica,sans-serif;font-size:25px;line-height:30px;font-weight:800;font-style:normal;color:#333333;text-decoration:none;letter-spacing:0px;">
                                            <singleline>
                                                {{-- <div mc:edit data-text-edit> Thank you for applying for the <br> <span style="color:#988460;">{{ucwords($application->career_detail->title)}}</span>. </div> --}}
                                                <div mc:edit data-text-edit> Thank you for applying through QC Legal for the <br> <span style="color:#988460;">{{ucwords($application->career_detail->title)}}</span> role. We truly appreciate the time and effort you have taken to submit your application. </div>
                                            </singleline>
                                        </td>
                                    </tr>
                                    ...
                                    <tr data-element="colibri-bm-paragraph" data-label="Paragraphs">
                                        <td class="center-text" data-text-style="Paragraphs" align="center" style="font-family:'Poppins',Arial,Helvetica,sans-serif;font-size:14px;line-height:24px;font-weight:400;font-style:normal;color:#333333;text-decoration:none;letter-spacing:0px;">
                                            <singleline>
                                                <div mc:edit data-text-edit>Our team will review your CV carefully and we aim to respond within 7 days. Please also note that due to the high volume of applications we receive, if you do not hear from us within this timeframe it means that, unfortunately your application has not been successful on this occasion.</div>
                                            </singleline>
                                        </td>
                                    </tr>
                                    ...
                                    <tr data-element="colibri-bm-paragraph" data-label="Paragraphs">
                                        <td class="center-text" data-text-style="Paragraphs" align="center" style="font-family:'Poppins',Arial,Helvetica,sans-serif;font-size:14px;line-height:24px;font-weight:400;font-style:normal;color:#333333;text-decoration:none;letter-spacing:0px;">
                                            <singleline>
                                                <div mc:edit data-text-edit>Thank you once again for your interest and we wish you every success in your career.</div>
                                            </singleline>
                                        </td>
                                    </tr>
                                @elseif($type == "admin")
                                    <tr data-element="colibri-bm-headline" data-label="Headlines">
                                        <td class="center-text" data-text-style="Headlines" align="center" style="font-family:'Poppins',Arial,Helvetica,sans-serif;font-size:25px;line-height:48px;font-weight:800;font-style:normal;color:#333333;text-decoration:none;letter-spacing:0px;">
                                            <singleline>
                                                <div mc:edit data-text-edit> <span style="color: #0B223E;">{{ ucwords($application->first_name . ' ' . $application->last_name) }}</span> applied for <span style="color:#988460;">{{ucwords($application->career_detail->title)}}</span> job. </div>
                                                @if ($application->cover_letter)
                                                    <div><p style="font-size: 1rem;;"><span style="font-weight: 600;">Message: </span>{{ $application->cover_letter }}</p></div>
                                                @endif
                                            </singleline>
                                        </td>
                                    </tr>
											...
											<table border="0" cellspacing="0" cellpadding="0" role="presentation" align="center" class="center-float">
												<tr>
													<td align="center" data-border-radius-default="0,6,36" data-border-radius-custom="Buttons" data-bgcolor="Buttons" bgcolor="#E38529" style="border-radius: 36px;">
														...
														<singleline> <a href="{{ url('uploads/cv')}}/{{$application->cv}}" download mc:edit data-button data-text-style="Buttons" style="font-family:'Poppins',Arial,Helvetica,sans-serif;font-size:16px;line-height:20px;font-weight:700;font-style:normal;color:#FFFFFF;text-decoration:none;letter-spacing:0px;padding: 15px 35px 15px 35px;display: inline-block;background-color: #0B223E;"><span>Download CV</span></a> </singleline>
													</td>
												</tr>
											</table>
										</td>
										...
										<table border="0" align="center" cellpadding="0" cellspacing="0" role="presentation" class="row" width="480" style="width:480px;max-width:480px;">
											<tr>
												<td class="center-text" data-text-style="Paragraphs" align="center" style="font-family:'Poppins',Arial,Helvetica,sans-serif;font-size:14px;line-height:24px;font-weight:300;font-style:normal;color:#666666;text-decoration:none;letter-spacing:0px;">
													<multiline>
														<div mc:edit data-text-edit style="font-weight: 600"> © {{date('Y')}} <a href="{{ route('home') }}" style="color: #988460">QC Legal</a>. All Rights Reserved.</div>
													</multiline>
												</td>
											</tr>
										</table>
